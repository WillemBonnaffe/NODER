...
##            - improve figures
## 21-03-2022 - created m_NODEGM_DEMC_v0_0.r
##            - implemented DEMC sampling of posterior
...
## load NODE functions
source("f_NODE_GM_v0_45.r")

## load data
TS = as.matrix(read.table("data/TS_LV_1.csv",sep=";",header=T))
#
