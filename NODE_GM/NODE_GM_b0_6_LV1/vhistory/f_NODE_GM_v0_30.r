...
fit.NODE = function(TS, N_e=30, W_o=100, W_p=100, sd1_o=0.01, sd2_o=0.1, sd1_p=0.01, sd2_p=0.1, alpha_o=10, alpha_p=10, method=1)
{
	...
	for(i in 1:N)
	{
		...
		#
		## plot effects 
		X_q0.05 = q05.ddx.ddt.Ybar_p * alpha_p
		X_q0.95 = q95.ddx.ddt.Ybar_p * alpha_p
		X_mean  = E.ddx.ddt.Ybar_p   * alpha_p
