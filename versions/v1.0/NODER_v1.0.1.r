...
## 05-06-2022 - created NODER_v1.0.1.r
##            - corrected error with .slice function
##            - would only distribute parameters to first and second variable
...
## .slice 
## goal: slice a vector x into a list of vectors of length specified by y
.slice = function(x,y)
{
	xList = list()
	for(i in 1:length(y))
