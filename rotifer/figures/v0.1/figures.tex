...
\figurePage{0.9}{
	...
	%
		...
		\def\dhspread{0.5}
		\def\vspread{3.7}
		\node [] at (-\hspread,0)  {\includegraphics[page=1,width=6cm]{supporting/TS_analysis_1.pdf}};
		\node [] at (0,0)          {\includegraphics[page=1,width=6cm]{supporting/TS_analysis_2.pdf}};
		\node [] at (\hspread,0)   {\includegraphics[page=1,width=6cm]{supporting/TS_analysis_3.pdf}};
		%
		%% legend
		\node [] at (\dhspread-\hspread,9.5) {\textbf{Replicate A}};
		\node [] at (\dhspread+0,9.5)         {\textbf{Replicate B}};
		\node [] at (\dhspread+\hspread,9.5)  {\textbf{Replicate C}};
...
\figurePage{0.9}{
	\begin{tikzpicture}[overlay]
		...
		\def\dhspread{0.5}
		\def\vspread{3.7}
		\node [] at (-\hspread,0)  {\includegraphics[page=2,width=6cm]{supporting/TS_analysis_1.pdf}};
		\node [] at (0,0)          {\includegraphics[page=2,width=6cm]{supporting/TS_analysis_2.pdf}};
		\node [] at (\hspread,0)   {\includegraphics[page=2,width=6cm]{supporting/TS_analysis_3.pdf}};
		%% legend
		\node [] at (\dhspread-\hspread,9.5) {\textbf{Replicate A}};
		\node [] at (\dhspread+0,9.5)         {\textbf{Replicate B}};
		\node [] at (\dhspread+\hspread,9.5)  {\textbf{Replicate C}};
...
\figurePage{0.9}{
	\begin{tikzpicture}[overlay]
		...
		\def\dhspread{0.5}
		\def\vspread{3.7}
		\node [] at (-\hspread,0)  {\includegraphics[page=3,width=6cm]{supporting/TS_analysis_1.pdf}};
		\node [] at (0,0)          {\includegraphics[page=3,width=6cm]{supporting/TS_analysis_2.pdf}};
		\node [] at (\hspread,0)   {\includegraphics[page=3,width=6cm]{supporting/TS_analysis_3.pdf}};
		%
		%% legend
		\node [] at (\dhspread-\hspread,9.5) {\textbf{Replicate A}};
		\node [] at (\dhspread+0,9.5)         {\textbf{Replicate B}};
...
\figurePage{0.9}{
	\begin{tikzpicture}[overlay]
	%
		\node [] at (0,0)         {\includegraphics[height=10cm,width=18cm]{supporting/summary.pdf}};
		%
		% %% legend
...
% 	%
% 		\def\hspread{6}
% 		\node [] at (\hspread,0)  {\includegraphics[height=6cm,width=6cm]{supporting/TS_DIN_1.pdf}};
% 		\node [] at (0,0)         {\includegraphics[height=6cm,width=6cm]{supporting/TS_DIN_2.pdf}};
% 		\node [] at (-\hspread,0) {\includegraphics[height=6cm,width=6cm]{supporting/TS_DIN_3.pdf}};
% 		%
% 		%% legend
